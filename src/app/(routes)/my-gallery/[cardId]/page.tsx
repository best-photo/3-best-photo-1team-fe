...
import { PhotoCard, getCardById, getDetailCard } from "@/src/services/mygalleryPhotocardService";
import PhotoCardDetail from "@/src/components/common/photoCard/organisms/photoCardDetail/photoCardDetail";
import { convertGradeToLowerCase, convertGenreToLowerCase } from '@/src/utils/convertCase';

export default function PhotoCardDetailPage({ params }: { params: { cardId: string } }) {
  const { cardId } = params;
  ...
  return (
    <div className="w-[1480px] mx-[240px]">
      <PhotoCardDetail
        ...
        soldAmount={photoCard.totalQuantity || 0}
