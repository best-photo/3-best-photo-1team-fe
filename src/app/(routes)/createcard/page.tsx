    ...
    <div className="flex items-center justify-center min-h-screen bg-black p-[15px] lg:p-[40px] md:p-[20px]">
      <div className="w-full max-w-[1480px]">
        <header className="text-center md:text-left mb-[20px]">
          <div onClick={() => router.push("/mygallery")} className="cursor-pointer block md:hidden">
            <Image src="/icons/direction/back.svg" width={22} height={22} alt="Back Icon" />
          </div>
          <h1 className="font-baskin lg:text-[62px] md:text-[48px] sm:text-[20px]">포토카드 생성</h1>
        ...
        >
          ...
          <div className="w-full">
            <label className="text-base md:text-base lg:text-lg font-normal">사진 업로드</label>
