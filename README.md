...
- 공통 컴포넌트
  - 공통 버튼
  ![image](https://github.com/user-attachments/assets/b3de94d7-23fb-4989-85a9-3397108e7d87)
  - 색상 및 높이에 따른 props를 통해 하나의 컴포넌트를 다양한 형태로 사용할 수 있도록 구현
  - className props 추가로 통해 props 설정 외 css 디자인이 필요시 추가할 수 있도록
  - 추가적인 스타일링이 필요한 경우 `className` props를 통해 외부 css를 추가할 수 있도록 구현
  - 버튼을 여러 형태로 재사용 가능하게 설계, 코드 중복 최소화

  - 카드 요약 컴포넌트
  ![image](https://github.com/user-attachments/assets/07fc1914-2683-4545-b5f8-daec01dbeba7)
...
- 마켓플레이스 페이지(구매자)
    - 마켓플레이스(구매자 관련)
        ...
        - 교환 실패 페이지
        - 교환제시 정보 입력 모달
- 마켓플레이스 페이지-판매 포토카드 상세
    - 마켓플레이스 페이지-판매 포토카드 상세 관련 모달
        - 승인하기 모달
        - 거절하기 모달
- 알림
    - 알림 모달
